...
export default function Product() {
  ...
  const filteredRecommendations = recommendations.filter(
    (prod) => String(prod.parentid) !== String(params.parentid),
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <View borderRadius={"30px"} overflow={"hidden"}>
                <img
                  src={selectedProduct.images[displayedImage]}
                  alt="cover"
                  style={{
                    width: "100%",
                    height: "100%",
            ...
            {/* separator */}
            <View border={"solid rgba(54, 6, 6, 0.2)"}></View>
            {/* product info */}
            <Flex
              flex={1}
              direction={"column"}
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "14px",
                    background:
                      Number(selectedProduct.stock_ml) <= 0
                    ...
                    cursor:
                      Number(selectedProduct.stock_ml) <= 0
                        ...
                        : "pointer",
                    transition:
                      "background-position 1s ease, transform 0.3s ease, box-shadow 0.3s ease",
                  }}
                  onMouseEnter={(e) => {
                  ...
                  >
                    ...
                    >
                      ...
                      <View minHeight="3.5rem">
                        <Text
                          style={{ ...bodyStyle, fontSize: "1.2rem" }}
                          textAlign="center"
                        >
                          {prod.name}
                        </Text>
                ...
                <Flex direction={"column"} alignItems={"center"} gap={"5px"}>
                  ...
                  <Flex alignItems={"center"}>
                    ...
                    >
                      ...
                      <img
                        src={ratings[Math.round(averageRating * 2)]}
                        width={"100%"}
                        alt=""
                      />
                    </View>
              ...
              <View textAlign={"left"}>
                ...
                {recentOrders.length > 0 && (
                  <h3 style={{ margin: "0", color: "green" }}>
                    Review your recent order of {selectedProduct.name} to earn
                    5% of its price in store credit!
                  </h3>
                )}
                <Flex
                  ...
                  <Flex direction={"column"} flex={"1"}>
                    <Flex direction={"column"} gap={"3px"}>
                      ...
                      <View
                        ...
                        backgroundColor={"rgba(80, 19, 19, 0.13)"}
                      >
                        <View className={styles.ratingOverlay}></View>
                        <img
                          src={ratings[selectedRating]}
                          width={"100%"}
                          alt=""
                        />
                      </View>
                    ...
                    <Flex alignItems={"end"}>
                      <textarea
                        ...
                        onFocus={(e) => {
                          e.target.style.outline = "2px solid rgba(0,0,0,.2)";
                        }}
                        onBlur={(e) => {
                ...
                <Flex direction={"column"}>
                  ...
                  >
                    ...
                    <View>
                      ...
                      >
                        <span>
                          {new Date(review.created).toLocaleString(undefined, {
                            year: "2-digit",
                            month: "2-digit",
                            day: "numeric",
                          })}
