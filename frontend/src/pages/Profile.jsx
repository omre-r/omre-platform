...
// Extracted from the main Profile render for readability. Receives blend data,
...
export default function Profile() {
  ...
  const totalCanceledOrders = userOrders.filter(
  ...
  const twoNoteBlends = loadedBlends.filter(
    (blend) => !blend.frag3_productid,
  ).length;
  const threeNoteBlends = loadedBlends.filter(
    (blend) => blend.frag3_productid,
  ).length;
  ...
  function getNoteButtonStyle(note) {
    ...
    return {
      ...
      background: isSelected
        ...
        : "linear-gradient(145deg,  #FDDDBE, #f9dad2)",
  ...
  return (
    <>
      ...
      >
        <Text style={luxuryHeadingStyle} marginTop="1rem">
        ...
        >
          ...
          {[
            ...
            { key: "preferences", label: "Favorite Notes" },
          ].map((tab) => (
            <Text
              key={tab.key}
              style={{
        ...
        >
            ...
            <View>
              ...
              <Grid templateColumns="repeat(2, 1fr)" gap="1.5rem">
                <View style={cardStyle}>
                  ...
                  <Text
                    style={{ ...luxurySubheadingStyle, color: "#FFFFFF" }}
                    textAlign={"left"}
                  >
              ...
              >
                ...
                <View position="relative">
                  ...
                  >
                    <option
                      value="all"
                      style={{ backgroundColor: "#9a2424", color: "#FFFFFF" }}
                    >
                      All Statuses
                    </option>
                    <option
                  ...
                  <Table>
                    ...
                    {userOrders
                      ...
                      .map((order) => {
                        ...
                        const canCancel = ["pending", "mixing"].includes(
                          status,
                        );
                        ...
                        return (
                          ...
                          >
                            <TableCell
                              style={{ ...tableBodyStyle, textAlign: "left" }}
                            >
                              <View
                                style={{
                                  ...tableViewStyle,
                                ...
                                >
                                  <View
                                    style={{
                                      ...
                                      cursor: "default",
                                      background:
                                        "linear-gradient(145deg, #341111c6, rgba(20, 20, 20, 0.71))",
          ...
          {activeTab === "sfl" && (
            <View>
              ...
              />
              <View minWidth={"500px"} maxWidth={"120%"} margin={"auto"}>
                {savedItems.length === 0 && (
          ...
          {activeTab === "preferences" && (
            <View>
              <Text marginBottom=".3rem" style={luxuryHeadingStyle2}>
                Which notes are you drawn to?
              </Text>
              <Text style={luxurySubheadingStyle} marginBottom="1rem">
          ...
          {confirmCancelOrder && (
            ...
            >
              <View
                style={{
                  background:
                    "linear-gradient(145deg,  #480e0ee0, rgb(20, 20, 20))",
                  padding: "50px",
                  borderRadius: "24px",
                  width: "400px",
                  textAlign: "center",
                  ...
                  <Button
                    ...
                    style={{
                      ...
                      background: cancelReason.trim()
                        ? "linear-gradient(145deg, #ff2525d7, rgba(20,20,20,0.92))"
                        : "linear-gradient(145deg, #f4f4f4, rgba(40,40,40,0.92))",
